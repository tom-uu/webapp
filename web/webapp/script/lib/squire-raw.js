...
var keyHandlers = {
    enter: function ( self, event, range ) {
        ...
        parent = getNearest( block, root, 'LI' );
        if ( parent ) {
            block = parent;
        }
...
var removeZWS = function ( root, keepNode ) {
    ...
    var parent, node = walker.nextNode(), index;
    while ( node ) {
...
var makeList = function ( self, frag, type ) {
    var walker = getBlockWalker( frag, self._root ),
        node = walker.nextNode(), tag, prev, newLi,
